...
from environment.basicEnv import BaiscEnvironment, BaiscVGNEnvironment
from environment.camera.camera import Camera
from graspGenerator.grasp_generator import GraspGenerator, VGNGraspGenerator
...
class GraspControl():
    ...
    def __init__(self,env,network_model):
        ...
        self.vgn_gg = VGNGraspGenerator("/home/user/air_ws/visionBasedManipulation/vgn/data/models/vgn_conv.pth", self.env.camera)
    ...
    def graspStateMachine(self):
        ...
        if  self.gState  == "Stop":
            ...
            # For testing VGN outputs
            self.vgn_gg.predict(rgb, depth)
