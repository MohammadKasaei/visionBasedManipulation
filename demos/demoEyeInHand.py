...
class GrasppingScenarios():
    ...
    def pileOfTubesScenario(self,runs, device, vis, output, debug):
        ...
        # eyeInHandCamPos = env.ee_pp 

        # eyeInHandCamera = Camera(env.ee_pp, (center_x, center_y, 0.785), 0.2, 2.0, (self.IMG_SIZE, self.IMG_SIZE), 40)
        # bgr2, depth2, _ = eyeInHandCamera.get_cam_img()
        # # cv2.imshow("test",bgr2)
