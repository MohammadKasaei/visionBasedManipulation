...
class BaiscVGNEnvironment:
    ...
    def __init__(self, GUI=False, debug=False, robotType ="UR5", img_size = 220,simulationStepTime=0.01) -> None:
        ...
        self.camera = VGNCamera(intrinsic=intrinsic, near=0.1, far=2.0, cam_pos=self.camPos, cam_target= self.camTarget)
    ...
    def creatPileofTube(self,n):
        ...
        for i in range(n):
            ...
            orn    = p.getQuaternionFromEuler([roll, 0, 0])
            pos    = [r_x, r_y, 1]
            obj_id = p.loadURDF("objects/tubes/tubes.urdf", pos, orn)
